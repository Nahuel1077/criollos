    ...
    <div className="gap-12 flex flex-col">
      ...
      <section id="reviews" className="gap-14 flex flex-col items-center">
        ...
        <div className="lg:flex lg:flex-row gap-10 justify-around grid grid-cols-1 items-center">
          <div className={`flex flex-col items-center lg:flex-row lg:flex-wrap content-start p-4 gap-4 shadow-lg w-[300px] bg-white text-black rounded-xl h-[235px] animate__animated ${animation}`}>
            <Image
      ...
      <section id="pricing" className="flex flex-col items-center w-full gap-2">
        <div className={`${montserrat.className} flex flex-row gap-8`}>
          <button onClick={() => setPricing("monthly")} className={`w-[75px] h-[25px] border-none rounded-lg hover:bg-gray ${pricing === "monthly" ? "bg-white text-black" : ""}`}>Monthly</button>
          <button onClick={() => setPricing("yearly")} className={`w-[75px] h-[25px] border-none rounded-lg hover:bg-gray ${pricing === "yearly" ? "bg-white text-black" : ""}`}>Yearly</button>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 justify-items-center lg:w-[80%] gap-8">
          <div className="w-[300px] h-[300px] lg:h-full flex flex-col items-center text-center lg:gap-[2rem] bg-white rounded-xl text-black shadow-2xl hover:scale-105 transition-all duration-75 ease-in-out">
            <h3 className={`${montserrat.className}`}>Basic</h3>
            <h2 className={`${montserrat.className} text-2xl font-[800]`}>{pricing === "monthly" ? "49.99 USD" : "549.99 USD"}</h2>
            <ul className={`${montserrat.className} text-start list-disc m-[2rem] self-start`}>
              <li>Web Development</li>
              <li>1 revision</li>
              <li>{pricing === "monthly" ? "1 update per month" : "12 updates total"}</li>
              <li>Landing Pages</li>
              <li>5 pages</li>
            </ul>
          ...
          <div className="w-[300px] h-[300px] lg:h-full flex flex-col items-center text-center lg:gap-[2rem] bg-white rounded-xl text-black shadow-2xl hover:scale-105 transition-all duration-75 ease-in-out">
            <h3 className={`${montserrat.className}`}>Intermediate</h3>
            <h2 className={`${montserrat.className} text-2xl font-[800]`}>{pricing === "monthly" ? "99.99 USD" : "1099.99 USD"}</h2>
            <ul className={`${montserrat.className} text-start list-disc m-[2rem] self-start`}> 
              <li>Web Development</li>
              <li>2 revisions</li>
              <li>{pricing === "monthly" ? "1 update per month" : "12 updates total"}</li>
          ...
          <div className="w-[300px] h-[300px] lg:h-full flex flex-col items-center text-center lg:gap-[2rem] bg-white rounded-xl text-black shadow-2xl hover:scale-105 transition-all duration-75 ease-in-out">
            ...
            <h2 className={`${montserrat.className} text-2xl font-[800]`}>{pricing === "monthly" ? "299.99 USD" : "2999.99 USD"}</h2>
            <ul className={`${montserrat.className} text-start list-disc m-[2rem] self-start`}>
              <li>Web Development</li>
              <li>Up to 4 revisions</li>
              <li>{pricing === "monthly" ? "2 update per month" : "24 updates total"}</li>
      ...
      <section id="contact" className="flex flex-col items-center gap-4"> {/*Contact*/}
        ...
        <div className="w-full md:w-[600px] h-[600px] md:h-[700px] flex flex-col bg-white rounded-xl text-black shadow-2xl">
